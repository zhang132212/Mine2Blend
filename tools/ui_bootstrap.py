...
execute('set_view',{'grid_id':g['grid_id'],'expected_revision':2,'view':{'renderer':'instances'}})
...
bpy.ops.wm.save_as_mainfile(filepath=str(root/'test-output/Editor-QA-Instances.blend'))
