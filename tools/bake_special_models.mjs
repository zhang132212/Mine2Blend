...
const ids=[];
const atlas={getTextureUV(id){const name=id.toString().replace(/^minecraft:/,'');let index=ids.indexOf(name);if(index<0){index=ids.length;ids.push(name);}return [index*2,0,index*2+1,1];},getPixelSize(){return 0;}};
